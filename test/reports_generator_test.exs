defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "whwn a file list is not provided, returns an error" do
      response = ReportsGenerator.build_from_many("qualquer coisa")
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the option is 'users', returns the most comsumed food" do
      file_name = "report_test.csv"
    ...
    test "when an ivalid option is given, returns an error" do
      file_name = "report_test.csv"

      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("fo")
